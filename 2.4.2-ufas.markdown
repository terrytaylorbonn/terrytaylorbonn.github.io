...
**[1 The requirement for a human-language <> computer interface](/2b-1-TF-only-interface/)**
...
**[2 Latent semantic computation](/2b-1a-latent-semantic-computation/)** (chat) 
...
**[6 CNN UFA](/2b-4-CNN-UFA/) (TODO)** (convoluted neural networks). 
...
**[7 TF UFA](/2b-5-TF-UFA/)** (transformer) 
