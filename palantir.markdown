...
My favorite project has been ZiptieAI.com. I created ZiptieAI.com without (human) assistance. ZiptieAI.com describes (with demos) the gist of AI drones, AI (neural networks, CNNs, and LLM models), and agents. My core focus has been AI algorithms and how to effectively use AI. My current focus is on Palantir Foundry (see https://ziptieai.com/pal/). Lab notes for all demos are available at https://drive.google.com/drive/folders/1-Adawag9uA8_bq-hDF-nOuPYaRLz1eEO.
...
I started using Palantir Foundry in early July 2026. Since then it's been like a good book that I can't put down. I have been focusing so far primarily on:
- **[S2 Examples](/3c.1b_pal_examples/)**. Do examples instead of demos to get started.
...
- **[S3 Demos](/3c.2_pal_initial_demos/)**. You just did project setup / pipeline (goal 1). You know your way around Foundry. Now do demos that cover the rest of basic core Foundry functionality. Get hands-on experience before doing "operational" apps (goal 3).
...
- **[S5 AIP/FDE start to finish projects](/3c.xxx_pal_gist/)**. This is the main goal. Creating real-world projects by working as a team with FDE (and AIP).
...
To train yourself hxxxxxxise" (WIP).
