...
- **[Demo 8 (model integration)](/3c.8_pal_8_model_integration/)** sections with AIP/FDE:
  - **2c.2**: pipeline + AI model » results
  - **2c.3-5**: deploy model / function / UI app (individual input / results)
  - **2c.X**: REAL WORLD detect from big data input (streaming??)<br><br>

This was my goal from the beginning:
- In first demos D1-D8 get enough experience so that 
