...
- [2.5 Published docs](https://github.com/terrytaylorbonn/auxdrone/wiki/LLM-stacks-%5C-5-Published-docs)
  ...
  - [2.5.2 Tech (MERN) stacks](https://github.com/terrytaylorbonn/auxdrone/wiki/Tech-stacks)
    - [D1 stack deployment](https://github.com/terrytaylorbonn/auxdrone/wiki/Stack-deployments)
    - [D2 Stack docs](https://github.com/terrytaylorbonn/auxdrone/wiki/Main-doc-deployments)
- [6 scraped docs (LLM/agent docs) (RAG)](https://github.com/terrytaylorbonn/auxdrone/wiki/LLM-stacks-%5C-6-Scraped-docs)
