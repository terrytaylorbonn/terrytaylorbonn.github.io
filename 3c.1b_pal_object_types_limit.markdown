...
- **1 Complicated setup in Workshop**
...
# **1 Complicated setup in Workshop** 26.0802
...
- FDE gave me a workflow that although worked, was wrong in a key place
- You need to use unique names to sift thru the confusion...
- And need a diagram (i will add this on 26.0803)
- Seemed like a strange bug in workshop (FDE agrees with this assessment.. more later)
...
**TAKEAWAY: I will create a very detailed demo to show the gist of this... be aware that this is not simple.**
