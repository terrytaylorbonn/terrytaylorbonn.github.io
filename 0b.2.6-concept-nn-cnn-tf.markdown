...
- Final NN
  ...
  Note that TF FFN is performed at every layer. This is probably necessary because language is much more complicated to compute from crude token input compared to the input pixels of a CNN.
