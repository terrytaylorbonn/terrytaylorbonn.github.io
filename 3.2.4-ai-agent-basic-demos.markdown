...
Very basic demos that show how **deterministic agents use TF/UFA semantic capabilities** *(these are marked with "@" and are explained on page [2.5 Agentic LLM (TF/UFA semantic) functionality](/2.5-agentic-llms/))*. 
