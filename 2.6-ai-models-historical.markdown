...
because it roughly follows the historical evolution of AI models.
For ZiptieAI, I'd treat most of these as: •	interesting side roads while:
- Core NN
- CNN
- Transformer
- JEPA / World Models
...
because when i see these talked about in the future 
