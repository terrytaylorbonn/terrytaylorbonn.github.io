...
When you are doing PAL exmaples/demos, you just follow the steps. But when you start to DIY, then things can get tricky. Especially when FDE makes mistakes. 
