...
*See also: [Core AI (LLM) concepts](https://github.com/terrytaylorbonn/auxdrone/wiki/Core-AI-concepts) · [LLM/TF misconceptions](/2.3.4_llm-tf-training/) · [UFAs](/2.4.2-ufas/)*
