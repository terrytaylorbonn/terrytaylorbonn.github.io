---
layout: page
title: "2.3.1 LLM gist"
permalink: /2.3.1-llm-gist/
---
...
This page describes concisely the gist of what an LLM model does without complex algorithms or architecture diagrams.
...
- **4 What an LLM actually is** (this is the GTP-generated version; the terms are all correct, but most people would struggle to understand exactly what its talking about; its a good example of the official narrative)
...
A [flip book](https://en.wikipedia.org/wiki/Flip_book) is a booklet with a series of images that very gradually change from one page to the next, so that when the pages are viewed in quick succession, the images appear to animate by simulating motion or some other change. The illusion of actual movement is created by your mind.
...
## **4 What an LLM actually is** (this is maybe repeat of other sections)
