---
layout: page
title: "2.4.2.2 UFA latent-semantic-computation"
permalink: /2.4.2.2-ufa-latent-semantic-compute/
---
...
### **ME1: "latent semantic computation".. can you explain?**
...
### **ME2: so (1) latent = hidden. what is meant is**
that 
- (2) while humans think of specific conceptual structures from our world,
- in cnn for example, lines become face parts, face parts become face, face becomes part of body, body type signifies what type of animal, but in the cnn the actual latent semantic representations (LSR) are probably 
...
### **ME3: so humans focus on the real world, LSR focuses on the real data** 
