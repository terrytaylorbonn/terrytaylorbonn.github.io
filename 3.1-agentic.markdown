...
**TOC** 
- **[3.3.1] [pal_core_01.detect.py (BINGO) 26.0411 (01 events / alerts)](/3.3.1_pal_core_01_detect/)**
- **[3.3.2] [pal_core_02_predict.py (BINGO) 26.0411 (02 road network / prediction)](/3.3.2_pal_core_02_predict/)**
- **[3.3.3] [pal_core_03_allocate.py (BINGO) 26.0411 (03 resources / allocation)](/3.3.3_pal_core_03_allocate/)**
- **[3.3.4] [pal_core_04 (BINGO) 26.0412 (04 graph / relationships) (see summary)](/3.3.4_pal_core_04_graph/)**
- **[3.3.5] [pal_core_05_operate.py (BINGO) (combine core01-04) 26.0415-16](/3.3.5_pal_core_05_operate/)**
- **[3.3.5b] [WITH AI \#592 "LLM bcd"](/3.3.5bcd_pal_core_05/)**
- **[3.3.6] [(WIP) pal_core_06: simplest demo of all core LLM roles 26.0416](/3.3.6_pal_core_06_all_roles/)**
- **[3.3.7] [pal_core_07_gmail_alerts.py // real emails as sensor stream (BINGO) 25.0423](/3.3.7_pal_core_07_gmail_alerts/)**
- **[3.3.8] [pal_core_08_plan.py // natural language → plan JSON → controlled execution (BINGO) 26.0423](/3.3.8_pal_core_08_plan/)**
- **[3.3.8b] [pal_core_08_plan.py + LLM (BINGO) 26.0424](/3.3.8b_pal_core_08_plan_LLM/)**
- **[3.3.9] [pal_core_09_optimize.py // improved allocation / optimization (BINGO) 26.0427](/3.3.9_pal_core_09_optimize/)**
