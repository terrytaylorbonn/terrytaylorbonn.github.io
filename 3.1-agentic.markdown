...
**This page will have short description for each demo with maybe a small pic in the TOC below.**

I believe these files were **named "pal_core" because they show the core deterministic functions in Palantir style non-AI agentic apps**. For details see 
