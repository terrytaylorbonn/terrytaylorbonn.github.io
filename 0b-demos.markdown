...
My demos take time and demo how AI is set of non-intelligent but extremely useful tools. My approach is **mechanistic**, because that's what AI tools are. **Binary, deterministic, mechanistic.** 

*PS: I created an AI demo series before. But I kept switching gears, often changing focus, reorganizing everything. That old material is still available in various locations on the*
