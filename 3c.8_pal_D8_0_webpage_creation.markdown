---
layout: page
title: How the demo D8 webpages were created (with GPT)
...
- **[1 GPT: GPT as a document-processing tool](#1-gpt-gpt-as-a-document-processing-tool)** (I asked GPT to create this text after we extracted the docx contents into markdown+PNGs)
- **[2 ME: Actual chat between ME and GPT used to extract demo D8 webpages](#2-me-actual-chat-between-me-and-gpt-used-to-extract-demo-d8-webpages)** (I manually copied the chat text with GPT into Markdown).

*Extraction version of the labnotes docx for the ZAI version of demo D8*<br><img src="/assets/D8/D8.0-00.png" alt="drones" width="90%" style="border: 1px solid #999;">
...
- `[**3c.8_pal_D8_1_demo_goal (0)**](http://127.0.0.1:4000/3c.8_pal_D8_1_demo_goal/)`
- `[**3c.8_pal_D8_2_model_studio (1a)**](http://127.0.0.1:4000/3c.8_pal_D8_2_model_studio/)`
- `[**3c.8_pal_D8_3_project (1b)**](http://127.0.0.1:4000/3c.8_pal_D8_3_project/)`
- `[**3c.8_pal_D8_4_train_mstudio (2a)**](http://127.0.0.1:4000/3c.8_pal_D8_4_train_mstudio/)`
- `[**3c.8_pal_D8_5_train_jupyter (2b)**](http://127.0.0.1:4000/3c.8_pal_D8_5_train_jupyter/)`
- `[**3c.8_pal_D8_6_inf_app (2c)**](http://127.0.0.1:4000/3c.8_pal_D8_6_inf_app/)`
