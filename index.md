...
*Note: The page and section numbering (such as "2b Models", "3b Projects") will be fixed in the future. I've reorganized this site many times, resulting in temporary "patch" numbering (b,c,...) for many pages and section headings. GPT remembers previous topics for weeks, so not changing numbering avoids a lot of confusion.* 
