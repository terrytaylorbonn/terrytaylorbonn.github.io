...
- **AI deep dive** *(see diagram below)*
  ...
  - **[2b Models](/2b_models/)**. Packaged AI models (primarily LLMs) available through an API. Fine-tuning, local models, deployment, and model serving. <!-- Fine-tuning, local models, deployment, RAG, and model serving. -->
